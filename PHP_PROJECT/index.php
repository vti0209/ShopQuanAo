...
<head>
    ...
    <title>Fashion VTishop</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <!-- <meta name="title" content="Fashion VTishop - Fashion VTishop" />
    <meta name="description" content="Fashion VTishop - Fashion VTishop" />
    <meta name="keywords" content="Fashion VTishop - Fashion VTishop" />
...
<?php } ?>
                    ...
                    <div class="title-product-main">
                    <h3 class="section-title">Những đối tác</h3>
                    </div>
                    </div> <!-- /product-main -->
                </div> <!-- /col -->
